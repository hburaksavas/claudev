...
| Corporate proxy/CA trust incompatibility for `GitFetch`/`MavenBuild` | Silent failure in exactly the locked-down environment this tool targets | Stated NFR, not yet implemented or tested. |
